local vault_path = vim.fn.expand("~") .. "/code/brain-2"
local md_file_pattern = "*.md"
local dynamic_workspace_marker_pattern = ".nvimobsidian"
return {
  ...
  opts = {
    ...
    mappings = {
      ...
      -- override default which remaps enter key
      ["<cr>"] = { action = function() end, opts = { buffer = true, expr = true } },
    },
